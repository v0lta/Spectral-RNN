#block(name=spec_loss, threads=1, memory=7500, subtasks=1, hours=8, gpus=1)
    ...
    ipython src/translate.py -- --learning_rate 0.005 --omit_one_hot True --cgru True --fft True --window_size 12 --step_size 6 --seq_length_in 36 --seq_length_out 25 --GPU 0 --window_fun hann --residual_velocities